...
# 13 "ECU_layer/led/../../MCAL_Layer/GPIO/../std_lib.h" 2
...
# 27 "ECU_layer/led/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
Std_ReturnType ecu_led_inistialize(const led_t* led)
{
  ...
  if(!(led) || (led->port_idx > 4) || (led->pin_idx > 7) || (led->led_stat > 1))
...
Std_ReturnType ecu_led_turn_on(const led_t* led)
{
  ...
  if(!(led) || (led->port_idx > 4) || (led->pin_idx > 7) || (led->led_stat > 1) || ( dir != output))
        ret = ((Std_ReturnType)0x00);
  else
    {
