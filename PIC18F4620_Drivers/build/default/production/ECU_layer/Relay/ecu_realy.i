...
# 2 "<built-in>" 2
# 1 "ECU_layer/Relay/ecu_realy.c" 2
...
# 13 "ECU_layer/Relay/../../MCAL_Layer/GPIO/../std_lib.h" 2
...
# 27 "ECU_layer/Relay/../../MCAL_Layer/GPIO/../mcal_std_types.h"
typedef uint8_t Std_ReturnType;
# 11 "ECU_layer/Relay/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2

# 1 "ECU_layer/Relay/../../MCAL_Layer/GPIO/../DeviceConfig/DeviceConfig.h" 1
...
# 114 "ECU_layer/Relay/../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 7 "ECU_layer/Relay/ecu_realy.c" 2




Std_ReturnType ecu_relay_inisialize(const relay_t* relay){
  Std_ReturnType ret_std = ((Std_ReturnType)0x01);
  if((!(relay)) || (relay->relay_port > 4) || (relay->relay_pin > 7))
    ret_std = ((Std_ReturnType)0x00);
  else{
        pinConfig_t pincfg = {
...
Std_ReturnType ecu_relay_turn_on(const relay_t* relay){
  ...
  if((!(relay)) || (relay->relay_port > 4) || (relay->relay_pin > 7))
        ...
        .direction = output,
        .logic = relay->relay_stat};
        ret_std = gpio_pin_write_logic (&pincfg , 0x01U);
    }
  return ret_std;
}
...
Std_ReturnType ecu_relay_turn_off(const relay_t* relay){
  ...
  if((!(relay)) || (relay->relay_port > 4) || (relay->relay_pin > 7))
        ...
        .direction = output,
        .logic = relay->relay_stat};
        ret_std = gpio_pin_write_logic (&pincfg , 0x00U);
    }
  return ret_std;
}
