...
# 13 "MCAL_Layer/timer1/../std_lib.h" 2
...
# 27 "MCAL_Layer/timer1/../mcal_std_types.h"
...
# 1 "MCAL_Layer/timer1/../GPIO/../DeviceConfig/DeviceConfig.h" 1
...
# 114 "MCAL_Layer/timer1/../GPIO/HAL_GPIO.h"
...
# 1 "MCAL_Layer/timer1/../interrupt/internal_interrupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/timer1/../interrupt/internal_interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 1
# 13 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h"
# 1 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h" 1
# 11 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h"
# 1 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 1
# 11 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h" 2
# 13 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 2
# 54 "MCAL_Layer/timer1/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0 ,
            INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_Layer/timer1/../interrupt/internal_interrupt/mcal_internal_interrupt.h" 2
...
static __attribute__((inline)) void timer1_counter_mode_select(const timer1_t* _timer);
...
Std_ReturnType timer1_init(const timer1_t* _timer){
  ...
  if(((void*)0) == _timer)
  ...
  else
    {
        ...
        (T1CONbits.TMR1CS = _timer->timer1_mode);


        if(_timer->timer1_mode == 1)
          {
            timer1_counter_mode_select(_timer);
          }


         (T1CONbits.RD16 = _timer->reg_rw_mode);
...
Std_ReturnType timer1_read_val(const timer1_t* _timer , uint16_t* _retVal){
  Std_ReturnType ret = ((Std_ReturnType)0x01);
  if(((void*)0) == _timer || ((void*)0) == _retVal)
    {
        ret = ((Std_ReturnType)0x00);
        return ret;
    }
...
# 152 "MCAL_Layer/timer1/hal_timer1.c"
static __attribute__((inline)) void timer1_counter_mode_select(const timer1_t* _timer)
{
