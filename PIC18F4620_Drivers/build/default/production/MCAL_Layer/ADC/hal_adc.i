...
# 10 "MCAL_Layer/ADC/../compiler.h" 2
# 12 "MCAL_Layer/ADC/../mcal_std_types.h" 2
# 27 "MCAL_Layer/ADC/../mcal_std_types.h"
typedef uint8_t Std_ReturnType;
# 12 "MCAL_Layer/ADC/hal_adc.h" 2

# 1 "MCAL_Layer/ADC/../interrupt/internal_interrupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/ADC/../interrupt/internal_interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 1
# 13 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h"
# 1 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h" 1
# 11 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h"
# 1 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 1
# 11 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h" 2
# 13 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 2

# 1 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../../../MCAL_Layer/GPIO/HAL_GPIO.h" 1
# 12 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../../../MCAL_Layer/GPIO/HAL_GPIO.h"
# 1 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../../../MCAL_Layer/GPIO/../DeviceConfig/DeviceConfig.h" 1
# 12 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 28 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum{
    low = 0,
    high
}logic_t;
...
# 114 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 14 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 2
# 54 "MCAL_Layer/ADC/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0 ,
            INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_Layer/ADC/../interrupt/internal_interrupt/mcal_internal_interrupt.h" 2
...
static ADC_INTERRUPT_HANDLER_t ADC_INTERRUPT_HANDLER = ((void*)0);




static __attribute__((inline)) void adc_input_channel_port_conf(uint8_t channel);
...
Std_ReturnType adc_init(const adc_conf_t* _adc){
  ...
  if((((void*)0) == _adc)){
      ...
      (ADCON0bits.CHS = _adc->default_channel);
...
Std_ReturnType adc_start_conversion(const adc_conf_t* _adc){
  Std_ReturnType ret = ((Std_ReturnType)0x00);
  if((((void*)0) == _adc) || ( 1 == (ADCON0bits.GODONE))){
      return ret;
    }
  else{
      (ADCON0bits.GO = 1);
...
Std_ReturnType adc_IsConversionDone(const adc_conf_t* _adc , uint8_t* conv_stat){
  Std_ReturnType ret = ((Std_ReturnType)0x00);
  if((((void*)0) == _adc) || (((void*)0) == conv_stat)){
      return ret;
    }
  else{
      *conv_stat = (uint8_t)((ADCON0bits.GODONE));

      ret = ((Std_ReturnType)0x01);
    }
  return ret;
}
# 190 "MCAL_Layer/ADC/hal_adc.c"
Std_ReturnType adc_GetResult(const adc_conf_t* _adc ,adc_result_t* ConvResult){
  Std_ReturnType ret = ((Std_ReturnType)0x00);
  if((((void*)0) == _adc) || (((void*)0) == ConvResult)){
      return ret;
    }
  else{
...
void ADC_ISR(void){
  (PIR1bits.ADIF = 0);
  if(((void*)0) != ADC_INTERRUPT_HANDLER)
