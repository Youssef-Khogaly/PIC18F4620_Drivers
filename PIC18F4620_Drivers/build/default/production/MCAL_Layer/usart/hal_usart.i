...
# 1 "MCAL_Layer/usart/../std_lib.h" 1
# 11 "MCAL_Layer/usart/../std_lib.h"
...
# 11 "MCAL_Layer/usart/../std_lib.h" 2
...
# 12 "MCAL_Layer/usart/../std_lib.h" 2
...
# 13 "MCAL_Layer/usart/../std_lib.h" 2
...
# 114 "MCAL_Layer/usart/../GPIO/HAL_GPIO.h"
...
# 1 "MCAL_Layer/usart/../interrupt/internal_interrupt/mcal_internal_interrupt.h" 1
# 12 "MCAL_Layer/usart/../interrupt/internal_interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 1
# 13 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h"
# 1 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h" 1
# 11 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h"
# 1 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 1
# 11 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_gen_cfg.h" 2
# 13 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h" 2
# 54 "MCAL_Layer/usart/../interrupt/internal_interrupt/../mcal_interrupt_cfg.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = 0 ,
            INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_Layer/usart/../interrupt/internal_interrupt/mcal_internal_interrupt.h" 2
...
# 132 "MCAL_Layer/usart/hal_usart.h"
...
static eusart_pfunc_CBF_t G_EUSART_Tx_CBF = ((void*)0);
static eusart_pfunc_CBF_t G_EUSART_Rx_CBF = ((void*)0);
static eusart_pfunc_CBF_t G_EUSART_FrameError_CBF = ((void*)0);
static eusart_pfunc_CBF_t G_EUSART_OverRunError_CBF = ((void*)0);
...
Std_ReturnType EUSART_Async_Init(const eusart_cfg_t *_eusart)
{
    ...
    else
    {
        ...
        if(_eusart->eusart_tx_cfg.eusart_tx_enable == 1)
        {
        ...
        if(_eusart->eusart_rx_cfg.eusart_rx_enable == 1)
        {
...
static void EUSART_Tx_init(const eusart_cfg_t *_eusart)
{
# 199 "MCAL_Layer/usart/hal_usart.c"
    if(_eusart->eusart_tx_cfg.eusart_tx_9bit_enable == 1)
    {
        TXSTAbits.TX9 = 1;
    }
    else {}
...
static void EUSART_Rx_init(const eusart_cfg_t *_eusart)
{
# 230 "MCAL_Layer/usart/hal_usart.c"
    if(_eusart->eusart_rx_cfg.eusart_rx_9bit_enable == 1)
    {
        RCSTAbits.RX9 = 1;
    }
    else {}
...
static void EUSART_BaudRateInit(const eusart_cfg_t *_eusart)
{
    ...
    switch(_eusart->baudrate_cfg)
    {
        case BAUDRATE_ASYNC_8BIT_LOW_SPEED :
            ...
            TXSTA1bits.SYNC = 0;
            BAUDCONbits.BRG16 = 0;
            SPBRG1 = (uint8_t)((((8*((1000000UL)))/(float_t)_eusart->baudrate) / 64.0f) - 1.0f);
            break;
        case BAUDRATE_ASYNC_8BIT_HIGH_SPEED :
            TXSTA1bits.BRGH = 1;
            TXSTA1bits.SYNC = 0;
            BAUDCONbits.BRG16 = 0;
            SPBRG1 = (uint8_t)((((8*((1000000UL)))/(float_t)_eusart->baudrate) /16.0f) - 1.0f);
            break;
        case BAUDRATE_ASYNC_16BIT_LOW_SPEED :
            TXSTA1bits.BRGH = 0;
            TXSTA1bits.SYNC = 0;
            BAUDCONbits.BRG16 = 1;
            baudRateVal = (float_t)( (((8*((1000000UL)))/(float_t)_eusart->baudrate) / 16.0f) - 1.0f );
        ...
        case BAUDRATE_ASYNC_16BIT_HIGH_SPEED :
            ...
            TXSTA1bits.SYNC = 0;
            BAUDCONbits.BRG16 = 1;
            baudRateVal = (float_t)((((8*((1000000UL)))/(float_t)_eusart->baudrate) / 4.0f) - 1.0f);
            SPBRG1 = (uint8_t)baudRateVal;
            SPBRGH = (uint8_t)((uint32_t)baudRateVal >> 8);
            break;
        case BAUDRATE_SYNC_8BIT :
            TXSTA1bits.SYNC = 1;
            BAUDCONbits.BRG16 = 0;
            SPBRG1 = (uint8_t)((((8*((1000000UL)))/(float_t)_eusart->baudrate) / 4.0f) - 1.0f);
            break;
