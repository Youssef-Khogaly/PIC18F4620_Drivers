...
# 1 "MCAL_Layer/SPI/../GPIO/../std_lib.h" 1
# 11 "MCAL_Layer/SPI/../GPIO/../std_lib.h"
...
# 11 "MCAL_Layer/SPI/../GPIO/../std_lib.h" 2
...
# 12 "MCAL_Layer/SPI/../GPIO/../std_lib.h" 2
...
# 13 "MCAL_Layer/SPI/../GPIO/../std_lib.h" 2
...
# 10 "MCAL_Layer/SPI/../GPIO/../compiler.h" 2
# 12 "MCAL_Layer/SPI/../GPIO/../mcal_std_types.h" 2
# 27 "MCAL_Layer/SPI/../GPIO/../mcal_std_types.h"
typedef uint8_t Std_ReturnType;
# 11 "MCAL_Layer/SPI/../GPIO/HAL_GPIO.h" 2

# 1 "MCAL_Layer/SPI/../GPIO/../DeviceConfig/DeviceConfig.h" 1
# 12 "MCAL_Layer/SPI/../GPIO/HAL_GPIO.h" 2
# 28 "MCAL_Layer/SPI/../GPIO/HAL_GPIO.h"
typedef enum{
    low = 0,
    high
}logic_t;
...
# 114 "MCAL_Layer/SPI/../GPIO/HAL_GPIO.h"
...
# 11 "MCAL_Layer/SPI/../interrupt/mcal_interrupt_gen_cfg.h"
# 1 "MCAL_Layer/SPI/../interrupt/mcal_interrupt_cfg.h" 1
# 11 "MCAL_Layer/SPI/../interrupt/mcal_interrupt_gen_cfg.h" 2
# 13 "MCAL_Layer/SPI/../interrupt/mcal_interrupt_cfg.h" 2
# 54 "MCAL_Layer/SPI/../interrupt/mcal_interrupt_cfg.h"
typedef enum {
...
# 1 "MCAL_Layer/SPI/../interrupt/internal_interrupt/mcal_internal_interrupt.h" 1
...
static SPI_InterruptHandler_t SPI_InterruptHandler_CBF = ((void*)0);
...
Std_ReturnType SPI_Transceive_SlaveSelect(const uint8_t Transmit_data , uint8_t* Rec_data , const pinConfig_t* SlaveSelectPin)
{
    ...
    if(Rec_data && SlaveSelectPin )
    {
        ...
        while( (SSPCON1bits.WCOL) == ((uint8_t)0x01))
        {
            (SSPCON1bits.WCOL = 0);
            SSPBUF = Transmit_data;
        }

        while((SSPSTATbits.BF) == ((uint8_t)0x00))
            ;
        *Rec_data = SSPBUF;
...
static void SPI_MasterMode_init(const SPI_cfg_t* _spi_cfg)
{
    ...
    TRISCbits.RC5 = output;
    (SSPSTATbits.SMP = _spi_cfg->spi_sample_mode);
    (SSPSTATbits.CKE = _spi_cfg->spi_clk_select);
    (SSPCON1bits.CKP = _spi_cfg->spi_clk_polarity);
    (SSPCON1bits.SSPM = _spi_cfg->spi_mode );
