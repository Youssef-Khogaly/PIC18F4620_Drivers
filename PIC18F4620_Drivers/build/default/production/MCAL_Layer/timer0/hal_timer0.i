...
# 13 "MCAL_Layer/timer0/../std_lib.h" 2
...
# 10 "MCAL_Layer/timer0/../compiler.h"
...
# 10 "MCAL_Layer/timer0/../compiler.h" 2
# 12 "MCAL_Layer/timer0/../mcal_std_types.h" 2
# 27 "MCAL_Layer/timer0/../mcal_std_types.h"
  ...
  if(((void*)0) == _timer)
  ...
  else
    {
      ...
      switch(_timer->timer0_mode)
      {
        case 1:
          (T0CONbits.T0CS = 1);
          (T0CONbits.T0SE = _timer->counter_source_edge);
          break;
...
# 91 "MCAL_Layer/timer0/hal_timer0.c"
