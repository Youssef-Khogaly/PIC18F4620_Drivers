	...
	; -M.ca/dist/Config_1/production/PIC18F4620.production.map \
	; -DXPRJ_Config_1=Config_1 -L--defsym=__MPLAB_BUILD=1 \
	; --dfp=D:/MPLAP/packs/Microchip/PIC18Fxxxx_DFP/1.3.36/xc8 --opt=+1 \
	; --opt=+asmfile --addrqual=ignore -P --warn=-3 --asmlist --std=c99 \
	; --output=+elf:multilocs --stack=compiled:auto:auto:auto \
	; --summary=+xml \
	; --summarydir=.ca/dist/Config_1/production/memoryfile.xml \
	; -oPIC18F4620.production.elf --objdir=.ca/dist/Config_1/production \
	; --outdir=.ca/dist/Config_1/production \
	; .ca/build/Config_1/production/ECU_layer/led/ECU_led.p1 \
	; .ca/build/Config_1/production/MCAL_Layer/DeviceConfig/DeviceConfig.p1 \
	; .ca/build/Config_1/production/MCAL_Layer/GPIO/HAL_GPIO.p1 \
	; .ca/build/Config_1/production/app.p1 -L--fixupoverflow=error \
